...
// Begin Datepicker
	...
	$(document.body).click(function(e) {
	  if( !$(e.target).is(".calendarDate, .calendarDate *, #departureDate, #returnDate, .ui-datepicker-next *, .ui-datepicker-prev *, #openDeparture, #openReturn") ) {
...
// End Datepicker
    ...
    var data2 = ["United States of America","Japan","France","Fiji","South West Pacific Cruise","England","Australia (Domestic Cruise)"]; //Popular Destinations  
